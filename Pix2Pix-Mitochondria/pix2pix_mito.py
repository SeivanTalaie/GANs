...
tar_images = []
tar_image_list = glob.glob("F:/Python/Datasets/mitochendry/training/img/*.png")
...
src_images = [] 
src_images_list = glob.glob("F:/Python/Datasets/mitochendry/training/mask/*.png")
...
g_model.save('Mito_generator.h5')
...
model = load_model('F:/Python/GAN/mito_pix2pix/model_039600.h5',
                   compile=False)
...
##########################################################
test_src_img = cv2.imread("F:/mitoc.png", 1)       

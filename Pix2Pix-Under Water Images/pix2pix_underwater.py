...
tar_images = []
tar_image_list = glob.glob("F:/Python/Datasets/under_water segmentation/train_val/images/*.jpg")

for path in tar_image_list[:500]:
...
src_images = [] 
src_images_list = glob.glob("F:/Python/Datasets/under_water segmentation/train_val/masks/*.bmp")

for path in src_images_list[:500]:
...
print(src_images_list[rand_num])
print(tar_image_list[rand_num])
...
train(d_model, g_model, gan_model, dataset, n_epochs=1000, n_batch=1) 

stop1 = datetime.now()
execution_time = stop1-start1
print("Execution time is: ", execution_time)

g_model.save('UWImage_generator.h5')
...
########################################################
# test_src_img = cv2.imread("F:/img1.png", 1)       
